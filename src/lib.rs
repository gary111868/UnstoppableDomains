// src/lib.rs
/*
 * Core library for UnstoppableDomains
 */
...
#[derive(Debug)]
pub struct UnstoppableDomainsProcessor {
    verbose: bool,
    processed_count: usize,
}

impl UnstoppableDomainsProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting UnstoppableDomains processing");
    
    let mut processor = UnstoppableDomainsProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = UnstoppableDomainsProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = UnstoppableDomainsProcessor::new(false);
